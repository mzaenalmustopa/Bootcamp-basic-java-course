package mzaenalmustopa.todolistjavadasaraplikasi.view;

import mzaenalmustopa.todolistjavadasaraplikasi.service.TodoListService;
import mzaenalmustopa.todolistjavadasaraplikasi.util.InputUtil;
    ...
    public void showTodoList() {
        while (true) {
            ...
            if (input.equals("1")) {
                ...
                System.out.println("Pilihan tidal dimengerti ");
            }
        }
    }
